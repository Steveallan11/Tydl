...
export function CustomerSignup() {
  ...
  const { signup, error: authError, clearError } = useCustomerAuth();
    ...
    <main className="bg-gradient-to-br from-brand-600 via-brand-500 to-blue-600 min-h-screen flex items-center justify-center px-6 py-12">
      <Card className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">Join Tydl and book your first clean</p>
        </div>
        ...
        <div className="mt-6 pt-6 border-t border-slate-200 text-center">
          <p className="text-slate-600">
            ...
            <Link to="/customer/login" className="text-brand-600 font-semibold hover:text-brand-700">
              Sign in
            </Link>
          </p>
        </div>
