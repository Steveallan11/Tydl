...
export function CheckoutDetails() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('[CheckoutDetails] Submitting booking directly');
      ...
      try {
        ...
        console.log('[CheckoutDetails] Customer profile refreshed');
      } catch (refreshError) {
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
              <p className="text-sm text-amber-900">
                ⚠️ <strong>Testing Mode:</strong> Payment processing is disabled. Click "Confirm Booking" to complete your booking.
              </p>
            </div>
